    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="prose prose-lg max-w-none">
        <p className="text-gray-600 mb-8">
          Utolsó frissítés: 2024. november 8.
        </p>
        ...
        <section className="mb-8">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            <p className="text-gray-700">
              <strong>Név:</strong> Webshop Kft.<br />
              <strong>Székhely:</strong> 1234 Budapest, Példa utca 12.<br />
              <strong>Email:</strong> info@webshop.hu<br />
              <strong>Adószám:</strong> 12345678-1-23
            </p>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mt-4">
            Jogaid gyakorlásához írj nekünk: <strong>info@webshop.hu</strong>
          </p>
        </section>
