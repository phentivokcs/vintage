...
interface CheckoutForm {
  ...
  street: string;
  floorDoor: string;
  shippingMethod: 'packeta' | 'foxpost' | 'dpd';
...
export default function CheckoutPage() {
  ...
  const calculateTotal = () => {
    ...
    const shippingFee = form.shippingMethod === 'dpd' ? 1200 : 990;
    ...
    try {
      ...
      const { data: billingAddress, error: billingError } = await supabase
        ...
        .insert({
          ...
          type: 'billing',
          country: form.billingAddressSame ? form.country : form.billingCountry,
          zip_code: form.billingAddressSame ? form.zipCode : form.billingZipCode,
          city: form.billingAddressSame ? form.city : form.billingCity,
          street: form.billingAddressSame ? form.street : form.billingStreet,
          floor_door: form.billingAddressSame ? form.floorDoor : form.billingFloorDoor,
          phone: form.phone,
        })
        .select()
        .single();
      ...
      if (billingError) {
        ...
        showToast('Számlázási cím létrehozása sikertelen', 'error');
      ...
      if (shippingError) {
        ...
        showToast('Szállítási cím létrehozása sikertelen', 'error');
      ...
      if (orderError || !order) {
        ...
        showToast('Megrendelés létrehozása sikertelen', 'error');
      ...
      for (const item of cartItems) {
        ...
        if (itemError) {
          ...
          showToast('Megrendelési tétel létrehozása sikertelen', 'error');
      ...
      showToast(error.message || 'Hiba történt a rendelés során. Kérjük, próbáld újra!', 'error');
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="lg:col-span-2">
            <form onSubmit={handleSubmit} className="bg-vintage-cream-light rounded-lg shadow-sm p-6 space-y-6">
              ...
              <div className="border-t pt-6">
                <h2 className="text-xl font-bold text-gray-900 mb-4">Szállítási cím</h2>
              ...
              <div className="border-t pt-6">
                <h2 className="text-xl font-bold text-gray-900 mb-4">Számlázási cím</h2>
                ...
                <div className="mb-4">
                  <label className="flex items-center">
                    <input
                      ...
                      className="mr-2"
                    />
                    <span className="text-sm text-gray-700">Megegyezik a szállítási címmel</span>
                  </label>
                </div>
                ...
                {!form.billingAddressSame && (
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setForm({ ...form, billingZipCode: e.target.value })}
                          placeholder="1234"
                          className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                        />
                      </div>
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        value={form.billingFloorDoor}
                        onChange={(e) => setForm({ ...form, billingFloorDoor: e.target.value })}
                        placeholder="2. em. 5."
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent"
                      />
                    </div>
              ...
              <div className="border-t pt-6">
                ...
                <div className="space-y-3">
                  ...
                  <label className="flex items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-gray-900 transition-colors">
                    ...
                    />
                    <div className="flex-1">
                      <div className="font-semibold">Házhozszállítás (DPD)</div>
                      <div className="text-sm text-gray-600">1-2 munkanap</div>
                    </div>
