  ...
  return (
    <>
      <SEO
        ...
        type="product"
      />
      <div className="min-h-screen bg-vintage-cream-light">
          ...
          <div>
            ...
            <div className="flex gap-3 mb-8">
              <button
                ...
                className="flex-1 py-4 bg-vintage-red text-white font-bold rounded-lg hover:bg-vintage-red/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
