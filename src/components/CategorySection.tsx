...
const categories = [
  {
    title: 'Felsők',
    description: 'Pólók, ingek, pulóverek',
    href: '/kategoria/felsok',
    icon: ShirtIcon,
    image: 'https://images.pexels.com/photos/4210850/pexels-photo-4210850.jpeg',
  },
  {
    title: 'Kiegészítők',
    description: 'Órák, táskák, kiegészítők',
    href: '/kategoria/kiegeszitok',
    icon: WatchIcon,
    image: 'https://images.pexels.com/photos/3731256/pexels-photo-3731256.jpeg',
  },
  {
    title: 'Cipők & Táskák',
    description: 'Sneakerek, táskák',
    href: '/kategoria/cipok-taskak',
