    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4 flex-wrap">
        ...
        <button
          ...
          className="px-4 py-2 bg-vintage-red text-white font-semibold rounded-lg hover:bg-vintage-red/90 transition-colors"
        >
          Frissítés
        </button>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredProducts.map((product) => {
            ...
            return (
              <div
                key={product.id}
                className="bg-vintage-cream-light border-vintage-beige/20 border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow"
              >
...
function ProductEditModal({ product, onClose, onSave }: ProductEditModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-vintage-cream-light rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-vintage-cream-light border-vintage-beige/20-b px-6 py-4 flex items-center justify-between">
        ...
        <div className="sticky bottom-0 bg-vintage-cream-light border-vintage-beige/20-t px-6 py-4 flex gap-3">
          <button
            onClick={onClose}
          ...
          <button
            ...
            className="flex-1 px-4 py-2 bg-vintage-red text-white font-semibold rounded-lg hover:bg-vintage-red/90 transition-colors"
          >
            Mentés
          </button>
        </div>
