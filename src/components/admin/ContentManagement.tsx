...
export default function ContentManagement() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-vintage-cream-light rounded-lg shadow p-6">
        {activeTab === 'hero' && (
          <HeroSection
            getValue={getValue}
        ...
        <div className="mt-6 flex justify-end gap-3">
          ...
          <button
            onClick={saveSection}
            disabled={saving}
            className="px-4 py-2 bg-vintage-red text-white rounded-lg hover:bg-vintage-red/90 flex items-center gap-2 disabled:opacity-50"
          >
