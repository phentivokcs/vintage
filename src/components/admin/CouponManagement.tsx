...
export default function CouponManagement() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await loadCoupons();
      resetForm();
      showToast(editingCoupon ? 'Kupon frissítve!' : 'Kupon létrehozva!', 'success');
    } catch (error) {
      console.error('Error saving coupon:', error);
      showToast('Hiba történt a kupon mentése során!', 'error');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-3 pt-4">
              <button
                type="submit"
                disabled={loading}
                className="px-6 py-2 bg-vintage-red text-white rounded-lg hover:bg-vintage-red/90 disabled:opacity-50"
              >
      ...
      <div className="bg-vintage-cream-light rounded-lg shadow-sm overflow-hidden">
