...
export default function QuickUpload() {
  ...
  const startCamera = async () => {
    try {
      ...
      showToast('Kamera hozzáférés sikertelen', 'error');
    }
  };
  ...
  const connectBluetooth = async () => {
    try {
      ...
      showToast('BT eszköz csatlakoztatva! (Demo mód - valós mérőszalag integráció fejlesztés alatt)', 'info');
    } catch (err) {
      showToast('Bluetooth csatlakozás sikertelen', 'error');
    }
  };
            ...
            {!cameraActive ? (
              <div className="grid grid-cols-2 gap-3 mb-4">
                <button
                  type="button"
                  onClick={startCamera}
                  className="py-4 px-6 bg-vintage-red text-white rounded-lg hover:bg-vintage-red/90 flex items-center justify-center gap-2 text-lg"
                >
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                {!btConnected && (
                  <button
                    ...
                    className="px-4 py-2 bg-vintage-red text-white rounded-lg hover:bg-vintage-red/90 flex items-center gap-2"
                  >
          ...
          <button
            ...
            className={`w-full py-5 text-xl font-semibold rounded-lg transition-colors flex items-center justify-center gap-2 ${
              loading || images.length === 0
                ...
                : 'bg-vintage-red text-white hover:bg-vintage-red/90'
            }`}
          >
            {loading ? (
              'Feltöltés...'
