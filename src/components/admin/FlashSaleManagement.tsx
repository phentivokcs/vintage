...
export default function FlashSaleManagement() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (error) {
      ...
      showToast('Akció sikeresen létrehozva!', 'success');
      setFormData({
        name: '',
        description: '',
        discount_percentage: 10,
    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-black text-white rounded-lg hover:bg-vintage-red/90"
        >
      ...
      {showForm && (
        <div className="bg-vintage-cream-light p-6 rounded-lg shadow-sm mb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-2">
              <button
                type="submit"
                className="px-4 py-2 bg-black text-white rounded-lg hover:bg-vintage-red/90"
              >
                Létrehozás
              </button>
              <button
      ...
      <div className="space-y-4">
        {sales.map((sale) => (
          <div key={sale.id} className="bg-vintage-cream-light p-6 rounded-lg shadow-sm">
