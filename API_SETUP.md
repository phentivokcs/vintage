...
**Környezeti változó:**
```
BILLINGO_API_KEY=47f4bd18-b99c-11f0-9c25-02cdfb5103ff
```
...
- **Fontos:** A block_id-t az edge function 166. sorában kell módosítani:
  ```typescript
  block_id: 0,  // <-- Cseréld ezt a számot a Billingo dashboard-ról
  ```
